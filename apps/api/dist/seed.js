    ...
    for (const b of brokerData) {
        ...
        if (!existingUser) {
            ...
            await brokerRepo.save(brokerRepo.create({
                ...
                status: broker_entity_1.BrokerStatus.LICENSED,
                district: b.district,
